"""systemd user unit `lakota-web.service`, written and enabled by the app. The household's
...
#: lakota-web.service does not exist."); anything else is a real failure. Deliberately narrow,
